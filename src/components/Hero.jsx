  ...
  return (
    <>
      ...
      <div id='contact' className=' text-white relative top-[-3vh] left-[15vw] w-[40vw] font-mono font-semibold flex justify-center '>
        ...
        <a href='https://github.com/PremChaurasiya07' target='_blank'> <li className='pl-[3vw] cursor-pointer transition-all' onMouseEnter={()=>seticon1(!icon1)} onMouseLeave={()=>seticon1(!icon1)}><FaGithub size={33}  color={!(icon1)?'teal':'white'}/></li></a>
          <a href='https://www.linkedin.com/in/prem-chaurasiya-58846332a/' target='_blank'><li className='pl-[3vw] cursor-pointer transition-all'  onMouseEnter={()=>seticon2(!icon2)} onMouseLeave={()=>seticon2(!icon2)}><FaLinkedin size={33} color={!(icon2)?'teal':'white'}/></li></a>  
          <a href="https://mail.google.com/mail/u/1/?view=cm&fs=1&to=premchaurasiya2006@gmail.com&tf=1
          " target='_blank'><li className='pl-[3vw] cursor-pointer transition-all'  onMouseEnter={()=>seticon3(!icon3)} onMouseLeave={()=>seticon3(!icon3)}><CgMail size={34} color={!(icon3)?'teal':'white'}/></li></a>   
         </ul>
      </div>
    </>
  )
